 ...
 * @author 		Sebs Studio
 * @category 	Admin
 * @package 	MailPoet bbPress Addon/Admin
 * @version 	1.0.0
 */

if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly

if ( ! class_exists( 'MailPoet_bbPress_Addon_Admin_Profile' ) ) {

	/**
	 * MailPoet_bbPress_Addon_Admin_Profile Class
	 */
	class MailPoet_bbPress_Addon_Admin_Profile {
...
return new MailPoet_bbPress_Addon_Admin_Profile();
